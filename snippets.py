        ...
        if updated_nodes.turn % 2 != 0 or updated_nodes.turn % 2 == 0:
            if self.__dict__['option'] == 'settlement':
                ...
                if updated_nodes.turn != 0:
                    ...
                    for node in G:
                        if type(node) == int:
                            if updated_nodes.dict_prop[node] == 'settlement_player_1':
                                ...
                                neighbors = [[node, element] for element in list(G.neighbors(node))]
                                print(neighbors)
                            # elif updated_nodes.dict_prop[node] == None and node == 2:
                            #     #print(node)
                            #     for x in edges_for_graphing:
                            #         if node in x:
                            #             print('yay')
                            #         # if x[1] == node and updated_nodes.dict_prop[x[0]] == 'settlement_player_1':
                            #         #     color_map.append('pink')
                            #         # elif x[1] == node and updated_nodes.dict_prop[x[1] == 'settlement_player_1':
                            #         #     print('pink')
                            ...
                            #     if updated_nodes.dict_prop[node[1]] == 'settlement_player_1':
                            #         color_map[x[2]].append('blue')
                            #     elif updated_nodes.dict_prop[x[2]] == 'settlement_player_1':
                            #         color_map[x[1]].append('blue')
                        else:
                            color_map.append('yellow')
                    ...
                    # print(color_map)
                    # print(edges_for_graphing)
                    # print(edges_for_graphing[0])
                    # print(updated_nodes.dict_prop)
                    # print(list(G.neighbors(1)))
                    # experiment = []
                    # for n in (list(G.neighbors(1))):
                    #     experiment.append((n, 1))
                    # print(experiment)
                    # print(updated_nodes.dict_prop_roads.keys())
                    # experiment_2 = []
                    # for n in (list(G.neighbors(1))):
                    #     print(G.edges(n))
                    #     experiment_2.append(list(G.edges(n)))
                    # print(experiment_2)
                    # experiment_3 = []
                    # for o in experiment_2:
                    #     for p in o:
                    #         experiment_3.append(list(p))
                    # print(experiment_3)
                    # for x in experiment_3:
                    #     x.sort()
                    # print(experiment_3)
            ...
            # graph drawing options for the case when a city is to be built
                ...
                for x in edges_list:
                    ...
                    if updated_nodes.turn % 2 != 0:
                        ...
                        if updated_nodes.dict_prop[x[0]] == 'settlement_player_1' or updated_nodes.dict_prop[x[1]] == 'settlement_player_1'\
            ...
            if event.button is MouseButton.LEFT and self.__dict__['option'] == 'road':
                ...
                for x in edges:
                    if x == coord_edges:
                        ...
                        edge_color_map_road.append('yellow')

                if coord_edges == ['None']:
                    edge_color_map_road = ['yellow']
