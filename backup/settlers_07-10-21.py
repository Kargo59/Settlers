...
class Graph:
    ...
    def create_graph(self):
        ...
        #edges between nodex in the middle of the graph and their direct neighbors
        ...
        #     neighbors_middle_nodes = list(G.neighbors(letter))
        #print(neighbors_middle_nodes)
                    ...
                    if type(node) == str and len(node) == 1:
                        ...
                        for c in list(G.neighbors(node)):
                            if updated_nodes.dict_prop[c] == 'settlement_player_2' or updated_nodes.dict_prop[c] == 'city_player_2':
                                #print(enum, node)
                                middle_node_colors_knight_card[enum] = 'black'
...
###########################################################       this section defines actions that happen when graph is clicked
        ...
        def on_click(event):
            ...
            if event.button is MouseButton.LEFT and self.__dict__['option'] == 'knight_card':
                ...
                print(sorted(edges_only_middle_nodes_letter_only))
                print(key_knight_card)
                ...
                try:
                    ...
                    for i in sorted(edges_only_middle_nodes_letter_only):
                        if i == key_knight_card[0]:
                            print('yay')
                            middle_node_colors_knight_card.append('red')
                        else:
                            middle_node_colors_knight_card.append('gold')
                ...
                if 'red' in middle_node_colors_knight_card:
...
def trade_bank():
    ...
    # Toplevel widget
    bank_window.title("New Window")

    # sets the geometry of toplevel
    bank_window.geometry("400x200")
    ...
    Label(bank_window, text="Your offer (4 cards of any color):", font=("Times New Roman", 20), padx = 10, pady = 10).grid(row=0,column=0,columnspan=5)
    button_rock = Button(bank_window, text = ' ', bg='dimgrey').grid(row=1,column=0)
    button_lumber = Button(bank_window, text = ' ', bg='forestgreen').grid(row=1,column=1)
    button_brick = Button(bank_window, text = ' ', bg='red').grid(row=1,column=2)
    button_sheep = Button(bank_window, text = ' ', bg='lime').grid(row=1,column=3)
    button_hay = Button(bank_window, text = ' ', bg='yellow').grid(row=1,column=4)
...
player1_trade_merchant = Button(root, width=20, height=1, bg='white', text='Merchant', font=('Times New Roman', 15, 'italic'))
...
player1_monopoly_card = Button(root, width=20, height=1, bg='white', text='Monopoly', font=('Times New Roman', 15, 'italic'))
