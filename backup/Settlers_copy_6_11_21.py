        ...
        if self.__dict__['option'] == 'merchant':
            ...
            if updated_nodes.turn % 2 != 0:
                if updated_nodes.dict_prop[1] == 'settlement_player_1' or updated_nodes.dict_prop[1] == 'city_player_1'\
                        or updated_nodes.dict_prop[2]== 'settlement_player_1' or updated_nodes.dict_prop[2]== 'city_player_1':
                    harbors_highlighted[0] = 'yellow'
                if updated_nodes.dict_prop[15] == 'settlement_player_1' or updated_nodes.dict_prop[15] == 'city_player_1'\
                        or updated_nodes.dict_prop[16]== 'settlement_player_1' or updated_nodes.dict_prop[16] == 'city_player_1':
                    harbors_highlighted[1] = 'yellow'
                if updated_nodes.dict_prop[28] == 'settlement_player_1' or updated_nodes.dict_prop[28] == 'city_player_1'\
                        or updated_nodes.dict_prop[39]== 'settlement_player_1' or updated_nodes.dict_prop[39] == 'city_player_1':
                    harbors_highlighted[2] = 'yellow'
                if updated_nodes.dict_prop[48] == 'settlement_player_1' or updated_nodes.dict_prop[48] == 'city_player_1'\
                        or updated_nodes.dict_prop[49]== 'settlement_player_1' or updated_nodes.dict_prop[49] == 'city_player_1':
                    harbors_highlighted[3] = 'yellow'
                if updated_nodes.dict_prop[51] == 'settlement_player_1' or updated_nodes.dict_prop[51] == 'city_player_1'\
                        or updated_nodes.dict_prop[52]== 'settlement_player_1' or updated_nodes.dict_prop[52] == 'city_player_1':
                    harbors_highlighted[4] = 'yellow'
                if updated_nodes.dict_prop[46] == 'settlement_player_1' or updated_nodes.dict_prop[46] == 'city_player_1'\
                        or updated_nodes.dict_prop[47]== 'settlement_player_1' or updated_nodes.dict_prop[47] == 'city_player_1':
                    harbors_highlighted[5] = 'yellow'
                if updated_nodes.dict_prop[37] == 'settlement_player_1' or updated_nodes.dict_prop[37] == 'city_player_1'\
                        or updated_nodes.dict_prop[38]== 'settlement_player_1' or updated_nodes.dict_prop[38] == 'city_player_1':
                    harbors_highlighted[6] = 'yellow'
                if updated_nodes.dict_prop[25] == 'settlement_player_1' or updated_nodes.dict_prop[25] == 'city_player_1'\
                        or updated_nodes.dict_prop[12]== 'settlement_player_1' or updated_nodes.dict_prop[12] == 'city_player_1':
                    harbors_highlighted[7] = 'yellow'
                if updated_nodes.dict_prop[9] == 'settlement_player_1' or updated_nodes.dict_prop[9] == 'city_player_1'\
                        or updated_nodes.dict_prop[10]== 'settlement_player_1' or updated_nodes.dict_prop[10] == 'city_player_1':
                    ...
                    if updated_nodes.turn % 2 != 0:
                        ...
                        for edge in edges_only_numbers:
                            if updated_nodes.dict_prop_roads[edge] == 'road_player_2':
                                ...
                                for element in edge:
                                    if updated_nodes.dict_prop[element] != 'settlement_player_2' and updated_nodes.dict_prop[element] != 'city_player_2'\
                                    and updated_nodes.dict_prop[element] != 'settlement_player_1' and updated_nodes.dict_prop[element] != 'city_player_1':
                                        ...
                                        for s in neighbors_to_build_settlements:
                                            if type(s) != int:
                                                neighbors_to_build_settlements.remove(s)
                                        if len(neighbors_to_build_settlements) == 2:
                                            if updated_nodes.dict_prop[neighbors_to_build_settlements[0]] != 'settlement_player_2' and\
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[1]] != 'settlement_player_2' and\
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[0]] != 'city_player_2' and\
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[1]] != 'city_player_2' and\
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[0]] != 'settlement_player_1' and\
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[1]] != 'settlement_player_1' and\
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[0]] != 'city_player_1' and\
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[1]] != 'city_player_1':
                                            ...
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[0]] != 'city_player_2' and \
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[1]] != 'city_player_2' and \
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[2]] != 'city_player_2' and \
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[0]] != 'city_player_1' and \
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[1]] != 'city_player_1' and \
                                            updated_nodes.dict_prop[neighbors_to_build_settlements[2]] != 'city_player_1':
                                                color_map[element-1] = ('yellow')
...
###########################################################################             road graph          #################################################################################
                ...
                for c in edges_list_no_middle:
                    ...
                    if updated_nodes.turn % 2 != 0:
                        ...
                        elif updated_nodes.dict_prop[c[0]] == 'settlement_player_1' or updated_nodes.dict_prop[c[1]] == 'settlement_player_1'\
                        or updated_nodes.dict_prop[c[0]] == 'city_player_1' or updated_nodes.dict_prop[c[1]] == 'city_player_1':
                        ...
                        elif updated_nodes.dict_prop[c[0]] == 'settlement_player_2' or updated_nodes.dict_prop[c[1]] == 'settlement_player_2'\
                        or updated_nodes.dict_prop[c[0]] == 'city_player_2' or updated_nodes.dict_prop[c[1]] == 'city_player_2':
                            edge_color_map.append('yellow')
                        else:
                            edge_color_map.append('black')
...
###################################################           drawing of the graph         #########################################################################3
        ...
        for s in updated_nodes.dict_prop:
            if updated_nodes.dict_prop[s] == 'settlement_player_1' or updated_nodes.dict_prop[s] == 'settlement_player_2':
        ...
        nx.draw_networkx_nodes(G, pos, edgecolors='black', linewidths=2, nodelist=node_list_settlements, node_color=node_color_settlements, node_shape='o', node_size=2000)
        nx.draw_networkx_nodes(G, pos, edgecolors='black', linewidths=2, nodelist=node_list_cities, node_color=node_color_cities, node_shape='p', node_size=3500)
        ...
        #highlights harbors that are available to trade with ('trade with merchant') button
            ...
            nx.draw_networkx_nodes(G, pos, nodelist=keys_labels_harbors, node_size=2000, node_shape='h', node_color=harbors_highlighted, edgecolors='black')
                ...
                if updated_nodes.turn % 2 != 0:
                    ...
                    for node in G:
                        if type(node) == int:
                            if updated_nodes.dict_prop[node] == 'settlement_player_1':
                                color_map_red[node-1] = ('blue')
                            elif updated_nodes.dict_prop[node] == 'settlement_player_2' and color_map_red[node-1] != 'red':
                                color_map_red[node-1] = ('violet')
                            elif updated_nodes.dict_prop[node] == 'city_player_1':
                                color_map_red[node - 1] = ('blue')
                            elif updated_nodes.dict_prop[node] == 'city_player_2':
...
#######################################  draws the graph with pop up windows after clicking the 'trade with merchant' button      ###################################################
                ...
                if len(key_merchant) != 0:
                    if (key_merchant == ['A1'] and harbors_highlighted[0] == 'yellow') or\
                        ...
                        Label(merchant_window, text="Your 3 cards:", font=("Times New Roman", 12), padx=10, pady=10).grid(
                        ...
                        # A Label widget to show in toplevel
                        Label(merchant_window, text="Trade for one of the following:", font=("Times New Roman", 12), padx=10, pady=10).grid(
...
Player_1 = Player(4, 4, 3, 3, 3, 3)
Player_2 = Player(4, 4, 3, 3, 3, 3)
...
def roll_dice():
    ...
    if roll_counter < 2:
        ...
        for element in neighbors_middle_node:
            if updated_nodes.dict_prop[element[0]] == 'settlement_player_1' or updated_nodes.dict_prop[element[0]] == 'city_player_1':
                price = element[1]
...
board_frame.place(x=270, y=-20)

########################################################            Scoreboard                  ###############################################################################3


# score_label = Label(root, width = 20, height=2, bg='lightskyblue', text='Score', font=('Times New Roman', 20, 'italic', 'bold'))
# score_label.place(x=1100, y=20)
#
# player_1_score_label = Label(root, width = 10, height=2, bg='lightskyblue', text='Player 1:', font=('Times New Roman', 16, 'italic', 'bold'))
# player_1_score_label.place(x=1100, y=80)
#
# player_2_score_label = Label(root, width = 10, height=2, bg='lightskyblue', text='Player 2:', font=('Times New Roman', 16, 'italic', 'bold'))
# player_2_score_label.place(x=1100, y=80)
#
# cities_settlements_score_label = Label(root, width = 20, height=2, bg='lightskyblue', text='Settlements / Cities:', font=('Times New Roman', 16, 'italic'))
# cities_settlements_score_label.place(x=1100, y=120)
#
# longest_road_score_label = Label(root, width = 20, height=2, bg='lightskyblue', text='The Longest Road:', font=('Times New Roman', 16, 'italic'))
# longest_road_score_label.place(x=1100, y=170)
#
# largest_army_score_label = Label(root, width = 20, height=2, bg='lightskyblue', text='The Largest Army:', font=('Times New Roman', 16, 'italic'))
# largest_army_score_label.place(x=1100, y=220)
#
# victory_points_score_label = Label(root, width = 20, height=2, bg='lightskyblue', text='Victory Points:', font=('Times New Roman', 16, 'italic'))
# victory_points_score_label.place(x=1100, y=270)
#
# total_score_label = Label(root, width = 20, height=2, bg='lightskyblue', text='Total:', font=('Times New Roman', 16, 'italic', 'bold'))
# total_score_label.place(x=1100, y=320)
...
#name of player 1
player1_name = Label(root, width = 20, height=2, bg='lightskyblue', text='Player 1\'s Turn', font=('Times New Roman', 20, 'italic', 'bold'))
player1_name.place(x=70, y=20)

#player 1 - resources label
player1_resource = Label(root, width = 9, height=2, bg='lightskyblue', text='Resources:', font=('Times New Roman', 16, 'italic'))
...
player1_roll_dice = Button(root, width = 20, height=1, bg='white', text= 'Roll dice', font=('Times New Roman', 15, 'italic'), command = roll_dice, state='normal')
...
player1_trade_merchant = Button(root, width=20, height=1, bg='white', text='Merchant', font=('Times New Roman', 15, 'italic'), command=trade_merchant)

#trade with bank button - submenu of "Trade" button!
player1_trade_bank = Button(root, width=20, height=1, bg='white', text='Bank', font=('Times New Roman', 15, 'italic'), command=trade_bank)
...
player1_build_settlement = Button(root, width=20, height=1, bg='white', text='Settlement', font=('Times New Roman', 15, 'italic'), command=change_view_settlement)

#build a city button - submenu of "build" button!
player1_build_city = Button(root, width=20, height=1, bg='white', text='Upgrade To a City', font=('Times New Roman', 15, 'italic'), command=change_view_city)
...
player1_buy_dev_card = Button(root, width=20, height=1, bg='white', text='Buy a Development Card', font=('Times New Roman', 15, 'italic'), command=buy_card)
...
year_of_plenty_amount.set('Year of Plenty' + ' (' + str(buy_development_card.cards_player_1.year_of_plenty) + ')')
player1_year_of_plenty_card = Button(root, width=20, height=1, bg='white', textvariable=year_of_plenty_amount, font=('Times New Roman', 15, 'italic'), command=year_of_plenty)

#use a 'Road building' card button - submenu of "Play dev card" button!
road_building_amount = StringVar()
road_building_amount.set('Road Building' + ' (' + str(buy_development_card.cards_player_1.road_building) + ')')
player1_road_building_card = Button(root, width=20, height=1, bg='white', textvariable=road_building_amount, font=('Times New Roman', 15, 'italic'), command=road_building_dev_card)

#use a 'Monopoly' card button - submenu of "Play dev card" button!
monopoly_amount = StringVar()
monopoly_amount.set('Monopoly' + ' (' + str(buy_development_card.cards_player_1.monopoly) + ')')
player1_monopoly_card = Button(root, width=20, height=1, bg='white', textvariable=monopoly_amount, font=('Times New Roman', 15, 'italic'), command=monopoly)
...
player1_confirm = Button(root, width = 3, height=1, bg='white', text=chr(10003), fg='green', font=('Times New Roman', 30), state='disable', command=confirm_selection)
...
#name of player 2
player2_name = Label(root, width = 20, height=2, bg='lightskyblue', text='Player 2\'s Turn', font=('Times New Roman', 20, 'italic', 'bold'))


hay2 = StringVar()
hay2.set(Player_2.hay)
#player 1 - displays the current number of hay cards
player2_hay_score = Label(root, width = 3, height=1, bg='white', textvariable= hay2, font=('Times New Roman', 15, 'italic'))
...
rock2.set(Player_2.rock)
#player 1 - displays the current number of rock cards
player2_rock_score = Label(root, width = 3, height=1, bg='white', textvariable= rock2, font=('Times New Roman', 15, 'italic'))
...
#player 1 - displays the current number of sheep cards
player2_sheep_score = Label(root, width = 3, height=1, bg='white', textvariable= sheep2, font=('Times New Roman', 15, 'italic'))
...
brick2.set(Player_2.brick)
#player 1 - displays the current number of brick cards
player2_brick_score = Label(root, width = 3, height=1, bg='white', textvariable= brick2, font=('Times New Roman', 15, 'italic'))
...
#player 1 - displays the current number of lumber cards
player2_lumber_score = Label(root, width = 3, height=1, bg='white', textvariable= lumber2, font=('Times New Roman', 15, 'italic'))
...
year_of_plenty_amount2.set('Year of Plenty' + ' (' + str(buy_development_card.cards_player_2.year_of_plenty) + ')')
player2_year_of_plenty_card = Button(root, width=20, height=1, bg='white', textvariable=year_of_plenty_amount2, font=('Times New Roman', 15, 'italic'), command=year_of_plenty)

#use a 'Road building' card button - submenu of "Play dev card" button!
road_building_amount2 = StringVar()
road_building_amount2.set('Road Building' + ' (' + str(buy_development_card.cards_player_2.road_building) + ')')
player2_road_building_card = Button(root, width=20, height=1, bg='white', textvariable=road_building_amount2, font=('Times New Roman', 15, 'italic'), command=road_building_dev_card)

#use a 'Monopoly' card button - submenu of "Play dev card" button!
monopoly_amount2 = StringVar()
monopoly_amount2.set('Monopoly' + ' (' + str(buy_development_card.cards_player_2.monopoly) + ')')
player2_monopoly_card = Button(root, width=20, height=1, bg='white', textvariable=monopoly_amount2, font=('Times New Roman', 15, 'italic'), command=monopoly)
