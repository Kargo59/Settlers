...
#########################################################         draws the 'merchant' graph        ##############################################################
        if self.__dict__['option'] == 'merchant':
            ...
            #marks the available harbors yellow - change later so that it reflects the turn!!!

            harbors_highlighted = ['white' for x in range(1,10)]

            if updated_nodes.turn % 2 != 0 or updated_nodes.turn % 2 == 0:
                if updated_nodes.dict_prop[1] == 'settlement_player_1' or updated_nodes.dict_prop[2]== 'settlement_player_1':
                    harbors_highlighted[0] = 'yellow'
                elif updated_nodes.dict_prop[15] == 'settlement_player_1' or updated_nodes.dict_prop[16]== 'settlement_player_1':
                    harbors_highlighted[1] = 'yellow'
                elif updated_nodes.dict_prop[28] == 'settlement_player_1' or updated_nodes.dict_prop[39]== 'settlement_player_1':
                    harbors_highlighted[2] = 'yellow'
                elif updated_nodes.dict_prop[48] == 'settlement_player_1' or updated_nodes.dict_prop[49]== 'settlement_player_1':
                    harbors_highlighted[3] = 'yellow'
                elif updated_nodes.dict_prop[51] == 'settlement_player_1' or updated_nodes.dict_prop[52]== 'settlement_player_1':
                    harbors_highlighted[4] = 'yellow'
                elif updated_nodes.dict_prop[46] == 'settlement_player_1' or updated_nodes.dict_prop[47]== 'settlement_player_1':
                    harbors_highlighted[5] = 'yellow'
                elif updated_nodes.dict_prop[37] == 'settlement_player_1' or updated_nodes.dict_prop[38]== 'settlement_player_1':
                    harbors_highlighted[6] = 'yellow'
                elif updated_nodes.dict_prop[25] == 'settlement_player_1' or updated_nodes.dict_prop[12]== 'settlement_player_1':
                    harbors_highlighted[7] = 'yellow'
                elif updated_nodes.dict_prop[9] == 'settlement_player_1' or updated_nodes.dict_prop[10]== 'settlement_player_1':
            ...
            # graph drawing options for the case when a city is to be built
                ...
                for c in edges_only_numbers:
                    ...
                    if updated_nodes.turn % 2 != 0:
                        ...
                        if updated_nodes.dict_prop[c[0]] == 'settlement_player_2' or updated_nodes.dict_prop[
                ...
                for r in edges_list:
                    ...
                    if updated_nodes.turn % 2 != 0:
                        if updated_nodes.dict_prop_roads[r] == 'road_player_1':
                            ...
                            available_roads_init = [a for a in available_roads_init if type(a[1]) == int]
                            ...
                            print(available_roads_init_sorted)
                            ...
                            list_enumerate_prime_2 = []
                            for a in list_enumerate_prime:
                                print(a[1][1])
                                if a[1][1] == int:
                                    list_enumerate_prime_2.appen
                            print(list_enumerate_prime_2)



                            for d in set(available_roads_init):
...
player1_knight_card = Button(root, width=20, height=1, bg='white', text='Knight Card', font=('Times New Roman', 15, 'italic'), command=knight_card)

#use a 'year of plenty' card button - submenu of "Play dev card" button!
player1_year_of_plenty_card = Button(root, width=20, height=1, bg='white', text='Year of Plenty', font=('Times New Roman', 15, 'italic'), command=year_of_plenty)
...
player1_monopoly_card = Button(root, width=20, height=1, bg='white', text='Monopoly', font=('Times New Roman', 15, 'italic'), command=monopoly)
