    ...
    def assign_road_value(self):
        ...
        if updated_nodes.turn % 2 != 0:
            ...
            for n in updated_nodes.dict_prop_roads:
                # if five_roads_player_1 == True and five_roads_player_2 != True:
                #     break
                ...
                if n == key_edges:  # 'key settlement' is a list created within the Graph.create_graph
                    ...
                    for elem in roads_neghbors[n]:
                        ...
                        if updated_nodes.dict_prop_roads[elem] != 'road_player_1':
                            ...
                            # five_roads_player_1 = False
                            # six_roads_player_1 = False
                                                    ...
                                                    for elem_elem_elem_elem_elem in fifth_segment:
                                                        if updated_nodes.dict_prop_roads[
                                                            ...
                                                            for part_5 in sixth_segment:
                                                                if part_5 == elem_elem_elem_elem:
                                                                    sixth_segment.remove(elem_elem_elem_elem)
                                                                print(sixth_segment)

                                                            six_roads_player_1 = True
                                                            if six_roads_player_1 == True and six_roads_player_2 != True:
                                                                break
                                                            ...
                                                            for elem_elem_elem_elem_elem_elem in sixth_segment:
                                                                if updated_nodes.dict_prop_roads[
                                                                    ...
                                                                    for part_6 in seventh_segment:
                                                                        if part_6 == elem_elem_elem_elem_elem:
                                                                            seventh_segment.remove(
                                                                                elem_elem_elem_elem_elem)

                                                                    seven_roads_player_1 = True

                                                                    if seven_roads_player_1 == True and seven_roads_player_2 != True:
                                                                        break
                                                                    ...
                                                                    for elem_elem_elem_elem_elem_elem_elem in seventh_segment:
                                                                        if updated_nodes.dict_prop_roads[
                                                                            ...
                                                                            seven_roads_player_1 = True
                                                                            eight_roads_player_1 = True

                                                                            if eight_roads_player_1 == True and eight_roads_player_2 != True:
                                                                                break
                                                                            ...
                                                                            for elem_elem_elem_elem_elem_elem_elem_elem in eighth_segment:
                                                                                if updated_nodes.dict_prop_roads[
                                                                                    ...
                                                                                    seven_roads_player_1 = True
                                                                                    eight_roads_player_1 = True
                                                                                    nine_roads_player_1 = True

                                                                                    if nine_roads_player_1 == True and nine_roads_player_2 != True:
                                                                                        break
                                                                                    ...
                                                                                    for elem_elem_elem_elem_elem_elem_elem_elem_elem in ninth_segment:
                                                                                        if \
                                                                                            ...
                                                                                            nine_roads_player_1 = True
                                                                                            ten_roads_player_1 = True

                                                                                            if ten_roads_player_1 == True and ten_roads_player_2 != True:
                                                                                                break
                                                                                            ...
                                                                                            for elem_elem_elem_elem_elem_elem_elem_elem_elem_elem in tenth_segment:
                                                                                                if \
                                                                                                    ...
                                                                                                    nine_roads_player_1 = True
                                                                                                    ten_roads_player_1 = True
                                                                                                    eleven_roads_player_1 = True

                                                                                                    if eleven_roads_player_1 == True and eleven_roads_player_2 != True:
                                                                                                        break
                                                                                                    ...
                                                                                                    for elem_elem_elem_elem_elem_elem_elem_elem_elem_elem_elem in eleventh_segment:
                                                                                                        if \
                                                                                                            ...
                                                                                                            ten_roads_player_1 = True
                                                                                                            eleven_roads_player_1 = True
                                                                                                            twelve_roads_player_1 = True

                                                                                                            if twelve_roads_player_1 == True and twelve_roads_player_2 != True:
                                                                                                                break

            print(five_roads_player_1)
            print(six_roads_player_1)
            ...
            elif five_roads_player_1 == True and five_roads_player_2 == True:
                Player_2.score -= 2
                score_player_2.set(str(Player_2.score) + ' Points')

            # six roads

            elif six_roads_player_1 == True and six_roads_player_2 != True:
                Player_1.score += 2
                score_player_1.set(str(Player_1.score) + ' Points')
            ...
            elif seven_roads_player_1 == True and seven_roads_player_2 != True:
                Player_1.score += 2
                score_player_1.set(str(Player_1.score) + ' Points')
            ...
            elif eight_roads_player_1 == True and eight_roads_player_2 != True:
                Player_1.score += 2
                score_player_1.set(str(Player_1.score) + ' Points')
            ...
            elif nine_roads_player_1 == True and nine_roads_player_2 != True:
                Player_1.score += 2
                score_player_1.set(str(Player_1.score) + ' Points')
            ...
            elif ten_roads_player_1 == True and ten_roads_player_2 != True:
                Player_1.score += 2
                score_player_1.set(str(Player_1.score) + ' Points')
            ...
            elif eleven_roads_player_1 == True and eleven_roads_player_2 != True:
                Player_1.score += 2
                score_player_1.set(str(Player_1.score) + ' Points')
            ...
            elif twelve_roads_player_1 == True and twelve_roads_player_2 != True:
                Player_1.score += 2
                score_player_1.set(str(Player_1.score) + ' Points')
            ...
            for n in updated_nodes.dict_prop_roads:
                ...
                if n == key_edges:                                      #'key settlement' is a list created within the Graph.create_graph
                    ...
                    longest_road_counter_player_2 = 1

                    print('thats the score' +str(five_roads_player_1))
                        ...
                        if updated_nodes.dict_prop_roads[elem] != 'road_player_2':
                            ...
                            for elem_elem in second_segment:
                                ...
                                if updated_nodes.dict_prop_roads[elem_elem] != 'road_player_2':
                                    longest_road_counter_player_2 = 2
                                    print(elem_elem)
                                    print('two roads in this direction, starting over')
                                    # five_roads_player_1 = False
                                    # six_roads_player_1 = False
                                    ...
                                    for elem_elem_elem in third_segment:
                                        ...
                                        if updated_nodes.dict_prop_roads[elem_elem_elem] != 'road_player_2':
                                            longest_road_counter_player_2 = 3
                                            print('three roads in this direction -  starting over')
                                            # five_roads_player_1 = False
                                            # six_roads_player_1 = False
                                            ...
                                            for elem_elem_elem_elem in fourth_segment:
                                                # if five_roads_player_1 == True:
                                                #     break
                                                if updated_nodes.dict_prop_roads[elem_elem_elem_elem] != 'road_player_2':
                                                    longest_road_counter_player_2 = 4
                                                    print('four roads in this direction -  starting over')
                                                    # five_roads_player_1 = False
                                                    # six_roads_player_1 = False

                                                elif updated_nodes.dict_prop_roads[elem_elem_elem_elem] == 'road_player_2':
                                                    # if five_roads_player_1 == True:
                                                    #     break
                                                    ...
                                                    five_roads_player_2 = True

                                                    if five_roads_player_2 == True and five_roads_player_1 != True:
                                                        break
                                                    ...
                                                    for elem_elem_elem_elem_elem in fifth_segment:
                                                        if updated_nodes.dict_prop_roads[elem_elem_elem_elem_elem] != 'road_player_2':
                                                            longest_road_counter_player_2 = 5
                                                            print('five roads in this direction -  starting over')
                                                            five_roads_player_2 = True
                                                            six_roads_player_2 = False

                                                        elif updated_nodes.dict_prop_roads[elem_elem_elem_elem_elem] == 'road_player_2':

                                                            sixth_segment = list(roads_neghbors[elem_elem_elem_elem_elem])
                                                            print('sixth segment')
                                                            for part_5 in sixth_segment:
                                                                if part_5 == elem_elem_elem_elem:
                                                                    sixth_segment.remove(elem_elem_elem_elem)
                                                            ...
                                                            six_roads_player_2 = True
                                                            if six_roads_player_2 == True and six_roads_player_1 != True:
                                                                break
                                                            ...
                                                            for elem_elem_elem_elem_elem_elem in sixth_segment:
                                                                if updated_nodes.dict_prop_roads[elem_elem_elem_elem_elem_elem] != 'road_player_2':

                                                                    five_roads_player_2 = True
                                                                    six_roads_player_2 = True
                                                                    seven_roads_player_2 = False

                                                                elif updated_nodes.dict_prop_roads[elem_elem_elem_elem_elem_elem] == 'road_player_2':

                                                                    seventh_segment = list(roads_neghbors[elem_elem_elem_elem_elem_elem])

                                                                    for part_6 in seventh_segment:
                                                                        if part_6 == elem_elem_elem_elem_elem:
                                                                            seventh_segment.remove(elem_elem_elem_elem_elem)

                                                                    seven_roads_player_2 = True

                                                                    if seven_roads_player_2 == True and seven_roads_player_1 != True:
                                                                        break
                                                                    ...
                                                                    for elem_elem_elem_elem_elem_elem_elem in seventh_segment:
                                                                        if updated_nodes.dict_prop_roads[
                                                                            ...
                                                                            seven_roads_player_2 = True
                                                                            eight_roads_player_2 = True

                                                                            if eight_roads_player_2 == True and eight_roads_player_1 != True:
                                                                                break
                                                                            ...
                                                                            for elem_elem_elem_elem_elem_elem_elem_elem in eighth_segment:
                                                                                if updated_nodes.dict_prop_roads[
                                                                                    ...
                                                                                    seven_roads_player_2 = True
                                                                                    eight_roads_player_2 = True
                                                                                    nine_roads_player_2 = True

                                                                                    if nine_roads_player_2 == True and nine_roads_player_1 != True:
                                                                                        break
                                                                                    ...
                                                                                    for elem_elem_elem_elem_elem_elem_elem_elem_elem in ninth_segment:
                                                                                        ...
                                                                                        updated_nodes.dict_prop_roads[
                                                                                            ...
                                                                                            nine_roads_player_2 = True
                                                                                            ten_roads_player_2 = True

                                                                                            if ten_roads_player_2 == True and ten_roads_player_1 != True:
                                                                                                break
                                                                                            ...
                                                                                            for elem_elem_elem_elem_elem_elem_elem_elem_elem_elem in tenth_segment:
                                                                                                if \
                                                                                                    ...
                                                                                                    nine_roads_player_2 = True
                                                                                                    ten_roads_player_2 = True
                                                                                                    eleven_roads_player_2 = True

                                                                                                    if eleven_roads_player_2 == True and eleven_roads_player_1 != True:
                                                                                                        break
                                                                                                    ...
                                                                                                    for elem_elem_elem_elem_elem_elem_elem_elem_elem_elem_elem in eleventh_segment:
                                                                                                        if \
                                                                                                            ...
                                                                                                            ten_roads_player_2 = True
                                                                                                            eleven_roads_player_2 = True
                                                                                                            twelve_roads_player_2 = True

                                                                                                            if twelve_roads_player_2 == True and twelve_roads_player_1 != True:
                                                                                                                break
            ...
            elif five_roads_player_2 == True and five_roads_player_1 == True:
                Player_1.score -= 2
                score_player_1.set(str(Player_1.score) + ' Points')

            # six roads

            elif six_roads_player_2 == True and six_roads_player_1 != True:
                Player_2.score += 2
                score_player_2.set(str(Player_2.score) + ' Points')
            ...
            elif seven_roads_player_2 == True and seven_roads_player_1 != True:
                Player_2.score += 2
                score_player_2.set(str(Player_2.score) + ' Points')
            ...
            elif eight_roads_player_2 == True and eight_roads_player_1 != True:
                Player_2.score += 2
                score_player_2.set(str(Player_2.score) + ' Points')
            ...
            elif nine_roads_player_2 == True and nine_roads_player_1 != True:
                Player_2.score += 2
                score_player_2.set(str(Player_2.score) + ' Points')
            ...
            elif ten_roads_player_2 == True and ten_roads_player_1 != True:
                Player_2.score += 2
                score_player_2.set(str(Player_2.score) + ' Points')
            ...
            elif eleven_roads_player_2 == True and eleven_roads_player_1 != True:
                Player_2.score += 2
                score_player_2.set(str(Player_2.score) + ' Points')
            ...
            elif twelve_roads_player_2 == True and twelve_roads_player_1 != True:
                Player_2.score += 2
                score_player_2.set(str(Player_2.score) + ' Points')
...
Player_1 = Player(0, 4, 10, 3, 10, 3, 0)
Player_2 = Player(0, 4, 3, 3, 3, 3, 0)
...
def roll_dice():
    ...
    if roll_counter < 2:
        ...
        for element in neighbors_middle_node:
            if updated_nodes.dict_prop[element[0]] == 'settlement_player_1' or updated_nodes.dict_prop[
                element[0]] == 'city_player_1':
                price = element[1]
            ...
            if updated_nodes.dict_prop[element[0]] == 'settlement_player_2' or updated_nodes.dict_prop[
                element[0]] == 'city_player_2':
                price = element[1]
                for a in mid_nodes_enumerated:
                    if price in a:
                        color_index = a[0]
