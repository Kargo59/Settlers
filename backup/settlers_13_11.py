            ...
            ###########################################################################             road graph          #################################################################################
                ...
                for c in edges_list_no_middle:
                    ...
                    # both starting settlements (for each player) have to have one road adjacent to them
                        ...
                        if updated_nodes.dict_prop_roads[c] == 'road_player_1':
                            ...
                            edge_color_map.append('violet')
                                ...
                                [c[1]] == 'settlement_player_2' or updated_nodes.dict_prop[c[0]] == 'city_player_2' or
                              updated_nodes.dict_prop[c[1]] == 'city_player_2'):
                            edge_color_map.append('yellow')
                    ...
                    if settlements_player_2 != 2:
                        ...
                        print(available_roads_player_2)
                        print('trakaka')
                        available_roads_player_2 = [c for c in available_roads_player_2 if
...
Player_2 = Player(0, 4, 10, 3, 10, 3, 0)
...
def end_turn():
    ...
    if updated_nodes.turn == 2:
        ...
        settlement_graph.create_graph()
        messagebox.showinfo('',
                            'Player 2, it\'s your turn to pick a settlement location. Since you\'re second in line, you will go twice.')
